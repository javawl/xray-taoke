...
public class ConstTk {
	...
	public static void main(String[] args) {
		String s = parseItemid("https://item.taobao.com/auction/noitem.htm?itemid=547885740250&catid=0");
		System.out.println(s);
		// System.out.println(parseItemid(
		// "<p><img
		// src=\"http://oss2.lanlanlife.com/993735f2b861dff83cb2ae806b52d1fc_1050x700.jpg\"><br>【2盒9.9元】葵花医用酒精棉片<br>券后6.8元包邮秒杀<br>3元优惠券:<a
		// target=\"_blank\"
		// href=\"https://uland.taobao.com/quan/detail?sellerId=3855935192&amp;activityId=de3d017d340e476ead2853bcebb258da\">https://uland.taobao.com/quan/detail?sellerId=3855935192&amp;activityId=de3d017d340e476ead2853bcebb258da</a><br>下单链接:<a
		// target=\"_blank\"
		// href=\"https://detail.tmall.com/item.htm?id=590086082864\">https://detail.tmall.com/item.htm?id=590086082864</a><br>【拍2盒9.9元共200片】药店一盒就要19.8元！家里常备，小东西大用途，磕磕碰碰消消毒都好用！用来擦手机屏和眼镜都很好用！独立小包装特别方便，每次用一片~&nbsp;&nbsp;<br></p>"));
		// System.out.println(parseItemid(
	...
	public static String parseItemid(String text) {
		if (text.contains("taobao.com") || text.contains("tmall.com") || text.contains("tmall.hk")) {
			...
			Matcher m2 = item_id_pattern.matcher(text);
			if (m2.find())
				return m2.group(1);
