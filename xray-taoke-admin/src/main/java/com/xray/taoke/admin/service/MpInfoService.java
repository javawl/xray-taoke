...
public class MpInfoService {
    ...
    public String getTradeSucc(String appid, UoUser user, OrderInfo data) {
        ...
        sb.append("----------------------------------\n");
        sb.append("输入关键字，搜索优惠券，如：连衣裙");
        return sb.toString();
    }

    public String getTradeSuccByJd(String appid, UoUser user, JdOrderInfo data) {
        StringBuffer sb = new StringBuffer();
        sb.append("━┉┉┉ 下 单 成 功 ┉┉┉━\n");
        sb.append("商品名称：").append(data.getStr("itemtitle")).append("\n");
        sb.append("订单编号：").append(data.getStr("tradeid")).append("\n");
    ...
    public String getCashSucc(String appid, Cashinfo data) {
        ...
        sb.append("\n");
        sb.append("[玫瑰]金额已打款到零钱，亲亲注意查收~");
        return sb.toString();
    }

    public String getProxyorder(String appid) {
        StringBuffer sb = new StringBuffer();
        sb.append("您的朋友下单啦[玫瑰]\n");
        sb.append("----------------------------------\n");
        sb.append("回复【查询】查看推广奖金~");
        return sb.toString();
    }
    ...
    public void setMpInfo(String appid, MpInfo mpinfo) {
        ...
        cond.put("jdkey", mpinfo.getStr("jdkey"));
        cond.put("jdid", mpinfo.getStr("jdid"));

        cond.put("pdname", mpinfo.getStr("pdname"));

        cond.put("templateid", mpinfo.getStr("templateid"));
    ...
    public void setPkeyPid(String pkey, String pid) {
        String key = prefix + "pkey";
        cache.hset(key, pkey, pid);
    }
