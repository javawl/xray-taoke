...
public class HaodankuService {
	...
	private static String singlebrand = "http://v2.api.haodanku.com/singlebrand/apikey/"
			+ ConstTk.config.get("hdk.apikey");
	private static String sales_list = "http://v2.api.haodanku.com/sales_list/apikey/"
			+ ConstTk.config.get("hdk.apikey");
	private static String column = "http://v2.api.haodanku.com/column/apikey/" + ConstTk.config.get("hdk.apikey");
	private static String supersearch = "http://v2.api.haodanku.com/supersearch/apikey/"
			+ ConstTk.config.get("hdk.apikey");
	...
	public JSONArray get_allitem_list(String keyword, int pno) throws Exception {
		String url = "https://www.haodanku.com/indexapi/get_allitem_list?keyword="
				+ URLEncoder.encode(URLEncoder.encode(keyword, "UTF-8"), "UTF-8") + "&sort=1&p=" + pno;
